...
#TOTAL AFTERNOON
total_value_afternoon=$(echo "scale=0; $today13 + $today14 + $today15 + $today16 + $today17 + $today18 + $today19 + $today20 + $today21 + $today22 + $today23 + $today0" | bc)
...
if [ -z "$tomorrow10" ]; then
    tomorrow10="0"
fi

if [ -z "$tomorrow11" ]; then
    tomorrow11="0"
fi

if [ -z "$tomorrow12" ]; then
    tomorrow12="0"
fi

if [ -z "$tomorrow13" ]; then
    tomorrow13="0"
fi

if [ -z "$tomorrow14" ]; then
    tomorrow14="0"
fi

if [ -z "$tomorrow15" ]; then
    tomorrow15="0"
fi

if [ -z "$tomorrow16" ]; then
    tomorrow16="0"
fi

if [ -z "$tomorrow17" ]; then
    tomorrow17="0"
fi

if [ -z "$tomorrow18" ]; then
    tomorrow18="0"
fi

if [ -z "$tomorrow19" ]; then
    tomorrow19="0"
fi

if [ -z "$tomorrow20" ]; then
    tomorrow20="0"
fi

if [ -z "$tomorrow21" ]; then
    tomorrow21="0"
fi

if [ -z "$tomorrow22" ]; then
    tomorrow22="0"
fi

if [ -z "$tomorrow23" ]; then
    tomorrow23="0"
fi
...
#NEXT6
if [ $HOUR == "1:00" ]; then next6_sum=$(echo "scale=0; $today1_1 + $today2_1 + $today3_1 + $today4_1 + $today5_1 + $today6_1 + $today1_2 + $today2_2 + $today3_2 + $today4_2 + $today5_2 + $today6_2 + $today1_3 + $today2_3 + $today3_3 + $today4_3 + $today5_3 + $today6_3" | bc); fi
if [ $HOUR == "2:00" ]; then next6_sum=$(echo "scale=0; $today2_1 + $today3_1 + $today4_1 + $today5_1 + $today6_1 + $today7_1 + $today2_2 + $today3_2 + $today4_2 + $today5_2 + $today6_2 + $today7_2 + $today2_3 + $today3_3 + $today4_3 + $today5_3 + $today6_3 + $today7_3 " | bc); fi
if [ $HOUR == "3:00" ]; then next6_sum=$(echo "scale=0; $today3_1 + $today4_1 + $today5_1 + $today6_1 + $today7_1 + $today8_1 + $today3_2 + $today4_2 + $today5_2 + $today6_2 + $today7_2 + $today8_2 + $today3_3 + $today4_3 + $today5_3 + $today6_3 + $today7_3 + $today8_3" | bc); fi
if [ $HOUR == "4:00" ]; then next6_sum=$(echo "scale=0; $today4_1 + $today5_1 + $today6_1 + $today7_1 + $today8_1 + $today9_1 + $today4_2 + $today5_2 + $today6_2 + $today7_2 + $today8_2 + $today9_2 + $today4_3 + $today5_3 + $today6_3 + $today7_3 + $today8_3 + $today9_3" | bc); fi
if [ $HOUR == "5:00" ]; then next6_sum=$(echo "scale=0; $today5_1 + $today6_1 + $today7_1 + $today8_1 + $today9_1 + $today10_1 + $today5_2 + $today6_2 + $today7_2 + $today8_2 + $today9_2 + $today10_2 + $today5_3 + $today6_3 + $today7_3 + $today8_3 + $today9_3 + $today10_3" | bc); fi
if [ $HOUR == "6:00" ]; then next6_sum=$(echo "scale=0; $today6_1 + $today7_1 + $today8_1 + $today9_1 + $today10_1 + $today11_1 + $today6_2 + $today7_2 + $today8_2 + $today9_2 + $today10_2 + $today11_2 + $today6_3 + $today7_3 + $today8_3 + $today9_3 + $today10_3 + $today11_3" | bc); fi
if [ $HOUR == "7:00" ]; then next6_sum=$(echo "scale=0; $today7_1 + $today8_1 + $today9_1 + $today10_1 + $today11_1 + $today12_1 + $today7_2 + $today8_2 + $today9_2 + $today10_2 + $today11_2 + $today12_2 + $today7_3 + $today8_3 + $today9_3 + $today10_3 + $today11_3 + $today12_3" | bc); fi
if [ $HOUR == "8:00" ]; then next6_sum=$(echo "scale=0; $today8_1 + $today9_1 + $today10_1 + $today11_1 + $today12_1 + $today13_1 + $today8_2 + $today9_2 + $today10_2 + $today11_2 + $today12_2 + $today13_2 + $today8_3 + $today9_3 + $today10_3 + $today11_3 + $today12_3 + $today13_3" | bc); fi
if [ $HOUR == "9:00" ]; then next6_sum=$(echo "scale=0; $today9_1 + $today10_1 + $today11_1 + $today12_1 + $today13_1 + $today14_1 + $today9_2 + $today10_2 + $today11_2 + $today12_2 + $today13_2 + $today14_2 + $today9_3 + $today10_3 + $today11_3 + $today12_3 + $today13_3 + $today14_3" | bc); fi
if [ $HOUR == "10:00" ]; then next6_sum=$(echo "scale=0; $today10_1 + $today11_1 + $today12_1 + $today13_1 + $today14_1 + $today15_1 + $today10_2 + $today11_2 + $today12_2 + $today13_2 + $today14_2 + $today15_2 + $today10_3 + $today11_3 + $today12_3 + $today13_3 + $today14_3 + $today15_3" | bc); fi
if [ $HOUR == "11:00" ]; then next6_sum=$(echo "scale=0; $today11_1 + $today12_1 + $today13_1 + $today14_1 + $today15_1 + $today16_1 + $today11_2 + $today12_2 + $today13_2 + $today14_2 + $today15_2 + $today16_2 + $today11_3 + $today12_3 + $today13_3 + $today14_3 + $today15_3 + $today16_3" | bc); fi
if [ $HOUR == "12:00" ]; then next6_sum=$(echo "scale=0; $today12_1 + $today13_1 + $today14_1 + $today15_1 + $today16_1 + $today17_1 + $today12_2 + $today13_2 + $today14_2 + $today15_2 + $today16_2 + $today17_2 + $today12_3 + $today13_3 + $today14_3 + $today15_3 + $today16_3 + $today17_3" | bc); fi
if [ $HOUR == "13:00" ]; then next6_sum=$(echo "scale=0; $today13_1 + $today14_1 + $today15_1 + $today16_1 + $today17_1 + $today18_1 + $today13_2 + $today14_2 + $today15_2 + $today16_2 + $today17_2 + $today18_2 + $today13_3 + $today14_3 + $today15_3 + $today16_3 + $today17_3 + $today18_3" | bc); fi
if [ $HOUR == "14:00" ]; then next6_sum=$(echo "scale=0; $today14_1 + $today15_1 + $today16_1 + $today17_1 + $today18_1 + $today19_1 + $today14_2 + $today15_2 + $today16_2 + $today17_2 + $today18_2 + $today19_2 + $today14_3 + $today15_3 + $today16_3 + $today17_3 + $today18_3 + $today19_3" | bc); fi
if [ $HOUR == "15:00" ]; then next6_sum=$(echo "scale=0; $today15_1 + $today16_1 + $today17_1 + $today18_1 + $today19_1 + $today20_1 + $today15_2 + $today16_2 + $today17_2 + $today18_2 + $today19_2 + $today20_2 + $today15_3 + $today16_3 + $today17_3 + $today18_3 + $today19_3 + $today20_3" | bc); fi
if [ $HOUR == "16:00" ]; then next6_sum=$(echo "scale=0; $today16_1 + $today17_1 + $today18_1 + $today19_1 + $today20_1 + $today21_1 + $today16_2 + $today17_2 + $today18_2 + $today19_2 + $today20_2 + $today21_2 + $today16_3 + $today17_3 + $today18_3 + $today19_3 + $today20_3 + $today21_3" | bc); fi
if [ $HOUR == "17:00" ]; then next6_sum=$(echo "scale=0; $today17_1 + $today18_1 + $today19_1 + $today20_1 + $today21_1 + $today22_1 + $today17_2 + $today18_2 + $today19_2 + $today20_2 + $today21_2 + $today22_2 + $today17_3 + $today18_3 + $today19_3 + $today20_3 + $today21_3 + $today22_3" | bc); fi
if [ $HOUR == "18:00" ]; then next6_sum=$(echo "scale=0; $today18_1 + $today19_1 + $today20_1 + $today21_1 + $today22_1 + $today23_1 + $today18_2 + $today19_2 + $today20_2 + $today21_2 + $today22_2 + $today23_2 + $today18_3 + $today19_3 + $today20_3 + $today21_3 + $today22_3 + $today23_3" | bc); fi
if [ $HOUR == "19:00" ]; then next6_sum=$(echo "scale=0; $today19_1 + $today20_1 + $today21_1 + $today22_1 + $today23_1 + $today0_1 + $today19_2 + $today20_2 + $today21_2 + $today22_2 + $today23_2 + $today0_2 + $today19_3 + $today20_3 + $today21_3 + $today22_3 + $today23_3 + $today0_3" | bc); fi
if [ $HOUR == "20:00" ]; then next6_sum=$(echo "scale=0; $today20_1 + $today21_1 + $today22_1 + $today23_1 + $today0_1 + $tomorrow1_1 + $today20_2 + $today21_2 + $today22_2 + $today23_2 + $today0_2 + $tomorrow1_2 + $today20_3 + $today21_3 + $today22_3 + $today23_3 + $today0_3 + $tomorrow1_3" | bc); fi
if [ $HOUR == "21:00" ]; then next6_sum=$(echo "scale=0; $today21_1 + $today22_1 + $today23_1 + $today0_1 + $tomorrow1_1 + $tomorrow2_1 + $today21_2 + $today22_2 + $today23_2 + $today0_2 + $tomorrow1_2 + $tomorrow2_2 + $today21_3 + $today22_3 + $today23_3 + $today0_3 + $tomorrow1_3 + $tomorrow2_3" | bc); fi
if [ $HOUR == "22:00" ]; then next6_sum=$(echo "scale=0; $today22_1 + $today23_1 + $today0_1 + $tomorrow1_1 + $tomorrow2_1 + $tomorrow3_1 + $today22_2 + $today23_2 + $today0_2 + $tomorrow1_2 + $tomorrow2_2 + $tomorrow3_2 + $today22_3 + $today23_3 + $today0_3 + $tomorrow1_3 + $tomorrow2_3 + $tomorrow3_3" | bc); fi
if [ $HOUR == "23:00" ]; then next6_sum=$(echo "scale=0; $today23_1 + $today0_1 + $tomorrow1_1 + $tomorrow2_1 + $tomorrow3_1 + $tomorrow4_1 + $today23_2 + $today0_2 + $tomorrow1_2 + $tomorrow2_2 + $tomorrow3_2 + $tomorrow4_2 + $today23_3 + $today0_3 + $tomorrow1_3 + $tomorrow2_3 + $tomorrow3_3 + $tomorrow4_3" | bc); fi
if [ $HOUR == "0:00" ]; then next6_sum=$(echo "scale=0; $today0_1 + $tomorrow1_1 + $tomorrow2_1 + $tomorrow3_1 + $tomorrow4_1 + $tomorrow5_1 + $today0_2 + $tomorrow1_2 + $tomorrow2_2 + $tomorrow3_2 + $tomorrow4_2 + $tomorrow5_2 + $today0_3 + $tomorrow1_3 + $tomorrow2_3 + $tomorrow3_3 + $tomorrow4_3 + $tomorrow5_3" | bc); fi
