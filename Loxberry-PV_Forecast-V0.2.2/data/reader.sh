...
#Calc Total Energy / Day
if [ $today == 1 ];then
if [ $hour == "01" ]; then today1=$value; fi
if [ $hour == "02" ]; then today2=$value; fi
if [ $hour == "03" ]; then today3=$value; fi
if [ $hour == "04" ]; then today4=$value; fi
if [ $hour == "05" ]; then today5=$value; fi
if [ $hour == "06" ]; then today6=$value; fi
if [ $hour == "07" ]; then today7=$value; fi
if [ $hour == "08" ]; then today8=$value; fi
if [ $hour == "09" ]; then today9=$value; fi
if [ $hour == "10" ]; then today10=$value; fi
if [ $hour == "11" ]; then today11=$value; fi
if [ $hour == "12" ]; then today12=$value; fi
if [ $hour == "13" ]; then today13=$value; fi
if [ $hour == "14" ]; then today14=$value; fi
if [ $hour == "15" ]; then today15=$value; fi
if [ $hour == "16" ]; then today16=$value; fi
if [ $hour == "17" ]; then today17=$value; fi
if [ $hour == "18" ]; then today18=$value; fi
if [ $hour == "19" ]; then today19=$value; fi
if [ $hour == "20" ]; then today20=$value; fi
if [ $hour == "21" ]; then today21=$value; fi
if [ $hour == "22" ]; then today22=$value; fi
if [ $hour == "23" ]; then today23=$value; fi
if [ $hour == "00" ]; then today0=$value; fi

#TOTAL MORING
if [ $hour -ge 1 ] && [ $hour -le 12 ]; then
total_value_morning=$(echo "scale=0; $total_value_morning + $value" | bc)
fi
#TOTAL AFTERNOON
if [ $hour -ge 13 ] && [ $hour -le 23 ]; then
total_value_afternoon=$(echo "scale=0; $total_value_afternoon + $value" | bc)
fi
#TOTAL TODAY
total_value_today=$(echo "scale=0; $total_value_today + $value + $today0" | bc)
fi

if [ $today == 0 ];then
if [ $hour == "01" ]; then tomorrow1=$value; fi
if [ $hour == "02" ]; then tomorrow2=$value; fi
if [ $hour == "03" ]; then tomorrow3=$value; fi
if [ $hour == "04" ]; then tomorrow4=$value; fi
if [ $hour == "05" ]; then tomorrow5=$value; fi
if [ $hour == "06" ]; then tomorrow6=$value; fi
if [ $hour == "07" ]; then tomorrow7=$value; fi
if [ $hour == "08" ]; then tomorrow8=$value; fi
if [ $hour == "09" ]; then tomorrow9=$value; fi
if [ $hour == "10" ]; then tomorrow10=$value; fi
if [ $hour == "11" ]; then tomorrow11=$value; fi
if [ $hour == "12" ]; then tomorrow12=$value; fi
if [ $hour == "13" ]; then tomorrow13=$value; fi
if [ $hour == "14" ]; then tomorrow14=$value; fi
if [ $hour == "15" ]; then tomorrow15=$value; fi
if [ $hour == "16" ]; then tomorrow16=$value; fi
if [ $hour == "17" ]; then tomorrow17=$value; fi
if [ $hour == "18" ]; then tomorrow18=$value; fi
if [ $hour == "19" ]; then tomorrow19=$value; fi
if [ $hour == "20" ]; then tomorrow20=$value; fi
if [ $hour == "21" ]; then tomorrow21=$value; fi
